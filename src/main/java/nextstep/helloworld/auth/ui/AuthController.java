...
public class AuthController {
    ...
    public ResponseEntity<Void> sessionLogin(String email, String password, HttpServletRequest request) {
    ...
    public ResponseEntity<MemberResponse> findMyInfo(HttpSession request) {
        // TODO: Session을 통해 인증 정보 조회하기 (key: SESSION_KEY)
        String email = String.valueOf(request.getAttribute(SESSION_KEY));
